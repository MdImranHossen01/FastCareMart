...
export const metadata: Metadata = {
  title: 'Privacy Policy | Fast Care Mart',
  description: 'Learn how Fast Care Mart collects, uses, and protects your personal information.',
};
...
export default async function PrivacyPage() {
  ...
  const contactEmail = settings.contact?.email || "support@FastCareMart.com";
