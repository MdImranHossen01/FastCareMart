  ...
  try {
    ...
    return {
      ...
      appleWebApp: {
        ...
        title: settings.brandName || "Fast Care Mart",
      },
      formatDetection: {
        telephone: false,
      },
      openGraph: {
        title: settings.metaTitle || settings.brandName || "Fast Care Mart",
        description: settings.metaDescription || settings.brandName || "Your ultimate destination for quality products.",
        url: baseUrl,
        siteName: settings.brandName || "Fast Care Mart",
        type: 'website',
      },
      twitter: {
