  ...
  try {
    ...
    if (!settings) {
      return NextResponse.json({
        brandName: process.env.NEXT_PUBLIC_STORE_NAME || "Fast Care Mart",
        contact: {
        ...
        marqueeText: "Welcome to Fast Care Mart! Your trusted online pharmacy and healthcare partner.",
        metaTitle: "Fast Care Mart - Online Pharmacy & Healthcare Store in Bangladesh",
        metaDescription: "Fast Care Mart is your trusted online medical shop in Bangladesh. Buy prescription medicines, OTC drugs, health supplements, wellness products, and medical devices online.",
        logoUrl: "/logo.webp",
